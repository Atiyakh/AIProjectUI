...
class LinePlotGeneratorWindow(QWidget):
    def __init__(self):
        ...
        self.initui_()
    def initui_(self):
        self.setWindowTitle("AI Algorithms - Line Plot")
        ## img
        pie_img_label = QLabel()
        pie_img_label.setPixmap(QPixmap("Database\\Archive\\static\\img\\line_plot.png"))
...
class ScatterPlotGeneratorWindow(QWidget):
    def __init__(self):
        ...
        self.initui_()
    def initui_(self):
        self.setWindowTitle("AI Algorithms - Scatter Plot")
        ## img
        pie_img_label = QLabel()
        pie_img_label.setPixmap(QPixmap("Database\\Archive\\static\\img\\scatter_plot.png"))
        pie_img_label.setAlignment(Qt.AlignCenter)
        self.layout_.addWidget(pie_img_label)
        ## elements widget
        self.elements_widget = QWidget()
...
class HistogramGeneratorWindow(QWidget):
    ...
    def initui_(self):
        ## img
        self.setWindowTitle("AI Algorithms - Histogram")
        pie_img_label = QLabel()
        pie_img_label.setPixmap(QPixmap("Database\\Archive\\static\\img\\histogram_graph.png"))
        pie_img_label.setAlignment(Qt.AlignCenter)
        self.layout_.addWidget(pie_img_label)
        ## elements widget
        self.elements_widget = QWidget()
...
class PieChartGeneratorWindow(QWidget):
    ...
    def initui_(self):
        ## img
        self.setWindowTitle("AI Algorithms - Pie Chart")
        pie_img_label = QLabel()
        pie_img_label.setPixmap(QPixmap("Database\\Archive\\static\\img\\pie_chart_preview.png"))
        pie_img_label.setAlignment(Qt.AlignCenter)
        self.layout_.addWidget(pie_img_label)
        ## elements widget
        self.elements_widget = QWidget()
